...
async function callTool(name, args = {}) {
  switch (name) {
    ...
    case 'update_product': {
      const data = {};
      for (const key of ['name', 'sku', 'price', 'minPrice', 'categoryId', 'presentationText', 'adMatchTokens', 'companionProductIds', 'supplierId', 'supplierArticle']) {
